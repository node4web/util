...
export * from "#$internalBinding_types";
export {
...
import { isKeyObject as isKeyObject2 } from "#internal/crypto/keys";
import { isCryptoKey as isCryptoKey2 } from "#internal/crypto/keys";

export function isKeyObject(obj) {
  if (!globalThis.process?.versions?.openssl) {
    return false;
  }

  return isKeyObject2(obj);
}
